      ...
      <PrintLayout title="Fiche d'évaluation" autoPrint>
        <EvaluationSheet
          grade={{
            ...
            status: "",
            finalScore: 0,
            evaluationCoefficients: sheet.evaluationCoefficients,
            individualScores: sheet.juryMembers.map((m) => ({ roleName: m.roleName, teacherName: m.teacherName, score: 0 })),
          }}
          studentNames={sheet.studentNames}
          juryRoleCoefficients={sheet.evaluationCoefficients}
        />
      </PrintLayout>
    </div>
  );
